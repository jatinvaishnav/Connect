...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        login_blurview_1.outlineProvider= ViewOutlineProvider.BACKGROUND
        login_blurview_1.clipToOutline=true

        login_blurview_2.outlineProvider= ViewOutlineProvider.BACKGROUND
        login_blurview_2.clipToOutline=true

        login_blurview_1.setupWith(window.decorView.findViewById(android.R.id.content))
        ...
        login_blurview_2.setupWith(window.decorView.findViewById(android.R.id.content))
            .setFrameClearDrawable(window.decorView.background)
            .setBlurAlgorithm(RenderScriptBlur(this))
            .setBlurRadius(4f)
            .setBlurAutoUpdate(true)
...
//        })
        ...
        login_button.setOnClickListener {
            ...
            if (email.isEmpty() && pass.isEmpty()) {
                ...
                login_password.setCompoundDrawablesWithIntrinsicBounds(
                    R.drawable.custom_lock_icon_err,
                    0,
                    0,
                    0
                )
            ...
            if (email.isEmpty()) {
                ...
                Toast.makeText(applicationContext, "Please enter your Email ID", Toast.LENGTH_SHORT)
                    .show()
                return@setOnClickListener
            }
            ...
            FirebaseAuth.getInstance().signInWithEmailAndPassword(email, pass)
                ...
                .addOnFailureListener {
                    if (it.message?.lowercase()!!.contains("network")) {
                        Toast.makeText(
                            applicationContext,
                            "Please check your network and try again",
                            Toast.LENGTH_SHORT
                        ).show()
                    } else if (it.message?.lowercase()!!.contains("invalid")) {
                        login_email.setBackgroundResource(R.drawable.login_input_fields_error)
                        login_email.setCompoundDrawablesWithIntrinsicBounds(
                            R.drawable.custom_email_icon_err,
                            0,
                    ...
                    } else if (it.message?.lowercase()!!.contains("blocked")) {
                        Toast.makeText(
                            applicationContext,
